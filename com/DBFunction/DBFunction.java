...
public class DBFunction {
    ...
    private static final String getFriend = "SELECT user_id2,user_group FROM user_relation where user_id1=?";
    ...
    public static void main(String[] args) {
        ...
        完成：
            ...
            好友添加
        待完成：
            查看资料卡（查询user表、user_relation表、group_information表）
            同意好友请求
            好友删除
            分组查询
            删除分组（删除分组，好友放入默认分组）
        ...
        pstmtCreateUser;
        pstmtSendMasssge;
        pstmtDeleteUnreadMassage;
        pstmtAddReadMasssge;
        pstmtCreateGroup;
        pstmtGetUnreadMassge;
        pstmtGetAllUnreadMassge;
        pstmtGetUserInfo;
        pstmtGetGroupInfo;
        */
        //用户登录（成功）
        judgeLogin(10001, "123456");
